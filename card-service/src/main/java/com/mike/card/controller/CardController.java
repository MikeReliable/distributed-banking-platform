...
public class CardController {
    ...
    public List<CardResponse> myCards(@PathVariable UUID userId, Authentication authentication) {
        return service.getCardsForUser(userId, authentication);
    }
    ...
    public CardResponse getCardById(@PathVariable UUID cardId, Authentication authentication) {
        return service.getById(cardId, authentication);
    }
    ...
    public void block(@PathVariable UUID cardId, Authentication authentication) {
        service.block(cardId, authentication);
    }
    ...
    public void close(@PathVariable UUID cardId, Authentication authentication) {
        service.close(cardId, authentication);
    }
